...
Arrow function은 익명함수를 좀 더 간략하게 표현할 수 있고, 직관적인 this을 제공한다. Arrow function은 항상 익명으로 사용한다. 문법은 아래와 같다.
...
<strong>Arrow function은 위의 규칙을 따르지 않고 언제나 자신을 포함하는 외부 scope에서 this를 계승 받는다.</strong>
