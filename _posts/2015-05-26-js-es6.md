...
### 3.2.1 Multiline Strings (복수행 문자열)
...
### 3.2.2 String Interpolation (문자열 삽입)
...
## 3.3 Extended Parameter Handling (함수 파라미터 확장)

### 3.3.1 Default Parameter value (기본 파라미터 초기값)
...
### 3.3.2 Rest Parameter (Rest 파라미터)
...
### 3.3.3 Spread Operator (Spread 연산자)
...
## 3.4 Destructuring (디스트럭처링)

Destructuring은 객체 또는 배열에 저장되어 있는 여러 값을 추출해내는 매우 편리한 방법이다.

### 3.4.1 Object destructuring (객체 디스트럭처링)
...
### 3.4.2 Array destructuring (배열 디스트럭처링)
...
### 3.5.3 Class Inheritance (클래스 상속)
