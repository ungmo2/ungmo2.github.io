...
[시멘틱 웹](http://ungmo2.github.io/html/HTML5-Semantic-Web/)의 의미를 살려서 제목 이외에는 사용하지 않는 것이 좋다. 검색엔진은 제목 태그를 중요한 의미로 받아들일 가능성이 크다.
...
input 태그는 다양한 종류가 있는데 type 속성에 의해 구분된다. form 태그 내에 존재하여야 입력 데이터를 전송할 수 있으나 [ajax](http://ungmo2.github.io/javascript/Ajax_JSON/)를 사용할 시에는 form 태그 내에 존재하지 않아도 된다.
...
자세한 내용은 [CSS display 속성](http://poiemaweb.com/css/CSS3-display/#display-)을 참조하기 바란다.
