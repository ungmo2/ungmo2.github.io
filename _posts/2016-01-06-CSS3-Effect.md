...
|:--------------|:----------------------------------|:-----:|
| ease          | cubic-bezier(0.25, 0.1, 0.25, 1.0) | ![](/img/cubic-bezier-ease-in.png){: style="max-width:50px; margin: 10px auto;"}
| linear        | cubic-bezier(0.0, 0.0, 1.0, 1.0) | ![](/img/cubic-bezier-ease-in.png){: style="max-width:50px; margin: 10px auto;"}
| ease-in       | cubic-bezier(0.42, 0, 1.0, 1.0) | ![](/img/cubic-bezier-ease-in.png){: style="max-width:50px; margin: 10px auto;"}
| ease-out      | cubic-bezier(0, 0, 0.58, 1.0) | ![](/img/cubic-bezier-ease-in.png){: style="max-width:50px; margin: 10px auto;"}
| ease-in-out   | cubic-bezier(0.42, 0, 0.58, 1.0) | ![](/img/cubic-bezier-ease-in.png){: style="max-width:50px; margin: 10px auto;"}
