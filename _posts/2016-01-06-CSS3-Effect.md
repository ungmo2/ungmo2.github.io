...
트랜스폼은 속성값으로 변환함수(transform function)를 사용한다. 사용할 수 있는 변환함수는 다음과 같다.
...
<html>
  <head>
    ...
    .spin.box.skew:hover {
      animation: skew 1s linear forwards;
    }
    @keyframes skew {
      100% {
        transform: skew(0, 0);
    ...
    .spin.box.complex:hover {
      animation: complex 1s linear forwards;
    }
    @keyframes complex {
      100% {
  ...
  <body>
    <div class="original box">
      <div class="spin box translate">translate</div>
    </div>
    <div class="original box">
      <div class="spin box scale">scale</div>
    </div>
    <div class="original box">
      <div class="spin box skew">skew</div>
    </div>
    <div class="original box">
      <div class="spin box rotate">rotate</div>
    </div>
    <div class="original box">
      <div class="spin box complex">complex</div>
    </div>
  </body>
</html>
```
