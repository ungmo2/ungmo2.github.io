...
함수 bar에서 참조하는 변수 x는 함수 foo에서 선언된 지역변수이다. 이는 실행 컨텍스트의 스코프 체인 탐색 방법에 따라 참조 순위에서 전역변수 x가 뒤로 밀렸기 때문이다. [Execution Context 참고](http://ungmo2.github.io/javascript/Javascript-Execution-Context/)
