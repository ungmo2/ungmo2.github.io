...
- Variable Object (VO / 변수객체)  
	...
	- 매개변수(function formal parameters)
	...
	함수 컨텍스트에서 VO는 Activation object(AO)를 가리키며 인수들의 정보를 배열의 형태로 담고 있는 객체인 [arguments object](http://ungmo2.github.io/javascript/Javascript-Function/#arguments-)와 매개변수가 추가된다.
