...
### \b \B
"Is this all there is?"의 경우 메타문자 \b는 아래의 <span style='color:red;'>|</span>의 위치를 가리킨다. 특수문자 전후도 포함됨에 주의하여야 한다.
...
이 문장에서 `/\bi.\b/ig`를 매치시킨 결과는 다음과 같다.
