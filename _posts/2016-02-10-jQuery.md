...
jQuery는 [CSS 스타일의 Selector](http://ungmo2.github.io/css/CSS3-Selector/)를 이용하여 요소를 선택할 수 있다. 이것은 [자바스크립트 DOM 쿼리](http://ungmo2.github.io/javascript/DOM/#dom-query--traversing--)보다 강력하며 유연하다.
