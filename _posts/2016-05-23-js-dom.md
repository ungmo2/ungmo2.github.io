...
<html>
  <body>
    ...
    <script>
      ...
      if (!inputUser.hasAttribute('name')) {
        // inputUser에 name 어트리뷰트를 추가하고 값으로 'user'를 설정
        inputUser.setAttribute('name', 'user');
      }

      // inputUser에 name 어트리뷰트의 값을 취득
      console.log(inputUser.getAttribute('name')); // user

      // inputUser에서 name 어트리뷰트를 제거
      inputUser.removeAttribute('name');

      // inputUser에서 name 어트리뷰트의 존재를 확인
      console.log(inputUser.hasAttribute('name')); // false
    </script>
  </body>
</html>
```
