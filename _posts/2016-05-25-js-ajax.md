...
[http://localhost:8888/loadhtml.html](http://localhost:8888/loadhtml.html)
...
[http://localhost:8888/loadjson.html](http://localhost:8888/loadjson.html)
...
```javascript
// http://poiemaweb.com/assets/data/data-jsonp
showTours({
  "tours": [
    {
      "region": "usa",
...
[http://localhost:8888/loadjsonp.html](http://localhost:8888/loadjsonp.html)
