...
[XMLHttpRequest.send](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/send) 메소드로 준비된 요청을 서버에 전달한다. XMLHttpRequest.send 메소드는 request body에 담아 전송할 인수를 사용할 수 있다.
