...
// 배열의 각 요소는 개별적인 인자로서 각각의 매개변수에 전달된다.
...
// 배열의 요소는 개별적인 인자로서 각각의 매개변수에 전달된다.
foo(...[1, 2, 3]);
```
...
Spread 연산자를 배열에서 사용하는 경우, 배열 리터럴 구문만으로 기존 배열을 새로운 배열의 일부로 만들 수 있다.
