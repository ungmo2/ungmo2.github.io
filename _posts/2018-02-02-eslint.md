...
2021년 10월 10일 출시된 eslint 8.0.0을 설치한 경우 [eslint-plugin-import가 정상 동작하지 않는 버그](https://github.com/eslint/eslint/issues/15148)가 있다. 이때 eslint 7+ 버전을 설치하면 정상 동작한다.
{:info}
