...
크롬 브라우저가 제공하는 개발자 도구(DevTools)는 웹 개발에 필수적인 강력한 도구이다. 개발자 도구는 브라우저에 기본 내장되어 있으므로 별도로 설치할 필요가 없다. 개발자 도구는 아래의 [단축키](https://developers.google.com/web/tools/chrome-devtools/shortcuts)로 오픈할 수 있다.
