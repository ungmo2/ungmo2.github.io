...
console.log(formatDate(new Date('1900/1/4'))); // "2021-01-04"
``` -->
...
getLastDayOfMonth(2021, 0); // => 31

// 2021년 2월의 마지막 날은 28일
getLastDayOfMonth(2021, 1); // => 28
```
...
const isEqualDate = (date1, date2) => Date.parse(date1) === Date.parse(date2);
``` -->
