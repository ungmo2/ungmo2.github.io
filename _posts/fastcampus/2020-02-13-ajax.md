...
| <strong>statusText</strong> | 요청에 대한 응답 메시지를 나타내는 문자열<br>예) "200 OK"
...
HTTP 요청 메소드는 클라이언트가 서버에게 요청의 종류와 목적을 알리는 방법이다. 주로 5가지의 요청 메소드(GET, POST, PUT, PATCH, DELETE)를 사용하여 CRUD를 구현한다.
